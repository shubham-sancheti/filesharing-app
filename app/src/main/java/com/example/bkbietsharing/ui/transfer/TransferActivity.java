package com.example.bkbietsharing.ui.transfer;
...
import com.example.bkbietsharing.R;
import com.example.bkbietsharing.ui.AboutActivity;
import com.example.bkbietsharing.ui.IntroActivity;
import com.example.bkbietsharing.ui.settings.SettingsActivity;
import com.example.bkbietsharing.transfer.TransferService;
import com.example.bkbietsharing.ui.explorer.ExplorerActivity;
import com.example.bkbietsharing.util.Permissions;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_report:
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(
                        "https://api.whatsapp.com/send?phone=917611816632&text=hey%20this%20messeage%20is%20regarding%20a%20query%20in%20Bkbiet%20sharing%20application%20-")));
                break;
