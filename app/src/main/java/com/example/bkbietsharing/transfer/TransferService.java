package com.example.bkbietsharing.transfer;
...
import com.example.bkbietsharing.bundle.Bundle;
import com.example.bkbietsharing.bundle.FileItem;
import com.example.bkbietsharing.discovery.Device;
import com.example.bkbietsharing.util.Settings;
...
public class TransferService extends Service {
    ...
    public static final String ACTION_START_LISTENING = "com.example.bkbietsharing.START_LISTENING";
    public static final String ACTION_STOP_LISTENING = "com.example.bkbietsharing.STOP_LISTENING";

    public static final String ACTION_START_TRANSFER = "com.example.bkbietsharing.START_TRANSFER";
    public static final String EXTRA_DEVICE = "com.example.bkbietsharing.DEVICE";
    public static final String EXTRA_URIS = "com.example.bkbietsharing.URLS";
    public static final String EXTRA_ID = "com.example.bkbietsharing.ID";

    public static final String ACTION_STOP_TRANSFER = "com.example.bkbietsharing.STOP_TRANSFER";
    public static final String ACTION_REMOVE_TRANSFER = "com.example.bkbietsharing.REMOVE_TRANSFER";
    public static final String EXTRA_TRANSFER = "com.example.bkbietsharing.TRANSFER";

    public static final String ACTION_BROADCAST = "com.example.bkbietsharing.BROADCAST";
